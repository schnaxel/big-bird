  ...
  return (
    <div className={"container"}>
      ...
      <p>
        Jens Lohmann
        <br />
        Straußenpark Nord GmbH
        <br />
        Bundesstr 7
        <br />
        24857 Fahrdorf
      </p>
      <p>Vertretungsberechtigte Personen: Jens Lohmann.</p>
      <p>E-Mail-Adresse: info@big-bird.de.</p>
      <p>
        Impressum: 
        <a href="http://www.big-bird.de/impressum.html" target="_blank">
          http://www.big-bird.de/impressum.html
        </a>
        .
      </p>
      ...
      <p>
        ...
        in Deutschland. Hierzu gehört insbesondere das Gesetz zum Schutz vor
      ...
      <ul className="m-elements">
        <li>
          ...
          Leistungen auf dem Gebiet der Bereitstellung von
          ...
          ALL-INKL.COM - Neue Medien Münnich, Inhaber: René Münnich, Hauptstraße
          68, 02742 Friedersdorf, Deutschland; Website:
          <a href="https://all-inkl.com/" target="_blank">
            https://all-inkl.com/
          </a>
      ...
      <ul className="m-elements">
        ...
        <li>
          <strong>Zwecke der Verarbeitung:</strong>
          Kontaktanfragen und Kommunikation, Feedback (z.B. Sammeln von Feedback
      ...
      <ul className="m-elements">
        <li>
          ...
          Soziales Netzwerk; Dienstanbieter: Instagram Inc., 1601 Willow Road,
