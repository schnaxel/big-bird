  ...
  return (
      <div className={'container'}>
        ...
        <div className="col-md-6 col-12 my-md-auto my-5 order-2 order-md-1">
            ...
            <div className="mt-4">
              <p>
                Im <a href="/shop">Hofladen</a> und <a href="/cafe">Café</a> gibt es immer etwas zu entdecken. Bioprodukte, Skandinavische 
                Deko, Schönes und Praktisches für die Küche, Wohnung und euren Garten, alles Rund um die Strauße, 
                Weine & Spirituosen.
              </p>
              <p>
                Kulinarisch verwöhnen wir euch mit selbstgemachten Torten, Kuchen, Muffins und weiteren Leckereien von Tante Dani und bestem Kaffee.
              </p>
            </div>
          </div>
        ...
        <div className="row mt-5 text-center">
          ...
          <div className="col-md-6 col-12 my-md-auto my-5">
            ...
            <div className="mt-4">
              <p>
                Im <a href="/alter-stall">„Alten Stall“</a> findet ihr handgemachte Möbel und Dekorationsartikel.
              </p>
            </div>
          </div>
        </div>
