    ...
    return (
        <section className="mt-4 p-4 bg-primary bg-opacity-10">
            <div className="row text-center text-muted mt-4">
                <div className="col-12 col-md-4 d-flex align-items-center justify-content-center flex-column px-4 border-end border-primary">
                ...
                <div className="col-12 col-md-8 px-4">
                    <h3>Café und Shop</h3>
                    <p className="mt-3 mb-4">Freitag bis Sonntag von 11 Uhr bis 17 Uhr</p>
                    <h3>Führungen</h3>
